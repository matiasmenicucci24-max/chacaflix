...
/* ============================================================
   FONDO ESTILO NETFLIX — mosaico de "pósters" usando los colores e
   íconos de las materias del sitio (no pósters reales, por derechos
...
function AuthBackground() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 0, overflow: "hidden", background: BG }}>
      ...
      {/* oscurecido general, igual que hace Netflix sobre su pared de pósters */}
      <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.72)" }} />
      <div style={{ position: "absolute", inset: 0, background: `linear-gradient(to bottom, transparent 0%, ${BG} 100%)` }} />
    </div>
  );
}
...
function AuthGate({ onAuthenticated, onAdminRequest }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 900, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", overflowY: "auto" }}>
      <AuthBackground />
...
function AdminLogin({ onSuccess, onCancel }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 900, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      <AuthBackground />
      <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center" }}>
